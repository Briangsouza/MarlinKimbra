...
#define DELTA_DIAGONAL_X_CORRECTION 0.0 // front left tower
#define DELTA_DIAGONAL_Y_CORRECTION 0.0 // front right tower
#define DELTA_DIAGONAL_Z_CORRECTION 0.0 // back middle tower
